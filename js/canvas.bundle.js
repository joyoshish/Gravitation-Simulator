...
var colors = ['#c52121', '#21c5c5', '#5ac521'];
var gravity = 0.1;
...
function init() {
  ...
  for (var i = 0; i < 200; i++) {
    var radius = Object(_utils__WEBPACK_IMPORTED_MODULE_0__["randomIntFromRange"])(10, 30);
...
function animate() {
  ...
  c.fillText('Click anywhere to restart', mouse.x, mouse.y);
}
